...
/*var times = ["00:00","00:05","00:10","00:15","00:20","00:25","00:30","00:35","00:40","00:45","00:50","00:55",
...
app.get('/', function (req, res) {
  res.sendFile(__dirname + '/semaforos-trafico.html');
});
...
app.get('/traffic', function (req, res) {
   ...
   var file;
   const fs = require('fs');
   file='trafico/CDMX_2020-01-14-'+times[i]+'.json'
...
app.get('/callescerradas', function (req, res) {
...
app.get('/roadclosed', function (req, res) {
...
app.get('/alcaldias', function(req,res){
   var file;
   const fs = require('fs');
   file='alcaldias.geojson'
   let rawdata = fs.readFileSync(file);
